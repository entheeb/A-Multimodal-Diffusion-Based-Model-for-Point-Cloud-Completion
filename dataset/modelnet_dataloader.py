...
class ModelnetDataset(Dataset):
    def __init__(self, h5_path="/home/obaidah/point-e/point_e/dataset/train_dataset_1024.h5", skip_classes=None):
...
if __name__ == "__main__":
    ...
    #check_incomplete_instances("/home/obaidah/point-e/point_e/dataset/train_dataset.h5")
    ...
    '''#log_instances_with_incomplete_partials("/home/obaidah/point-e/point_e/dataset/train_dataset.h5", min_points=4096)
    check_mean_variance(
    h5_path="/home/obaidah/point-e/point_e/dataset/train_dataset.h5",
    batch_size=32,
    num_workers=4
